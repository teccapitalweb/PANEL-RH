...
/* Colaboradores (expediente completo). En producción: colección
   `colaboradores` filtrada por empresaId con reglas de seguridad por tenant. */
const DEMO_COLABORADORES = [
  { id: "c001", empresaId: "tec-capital", nombre: "Miguel Ángel Ruiz", puesto: "Líder de Desarrollo", area: "Tecnología", ingreso: "2023-02-01", estatus: "Activo",
  ...
  { id: "c002", empresaId: "tec-capital", nombre: "Britney Salas", puesto: "Coordinadora Dev", area: "Tecnología", ingreso: "2023-05-15", estatus: "Activo",
  ...
  { id: "c003", empresaId: "tec-capital", nombre: "Jesús Hernández", puesto: "Desarrollador", area: "Tecnología", ingreso: "2024-01-09", estatus: "Activo",
  ...
  { id: "c004", empresaId: "tec-capital", nombre: "Ricardo Olmos", puesto: "Soporte IPCI", area: "Operación", ingreso: "2022-09-08", estatus: "Activo",
  ...
  { id: "c005", empresaId: "tec-capital", nombre: "Laura Mendoza", puesto: "Administración", area: "Finanzas", ingreso: "2023-11-20", estatus: "Vacaciones",
  ...
  { id: "c006", empresaId: "tec-capital", nombre: "Carlos Vega", puesto: "Ventas", area: "Comercial", ingreso: "2024-03-04", estatus: "Activo",
  ...
  { id: "c007", empresaId: "dermalysse", nombre: "Ana Sofía Torres", puesto: "Dermoconsultora", area: "Clínica", ingreso: "2023-07-01", estatus: "Activo",
  ...
  { id: "c008", empresaId: "dermalysse", nombre: "Paola Ríos", puesto: "Recepción", area: "Operación", ingreso: "2024-02-19", estatus: "Activo",
  ...
  { id: "c009", empresaId: "fisioteck", nombre: "David Castro", puesto: "Fisioterapeuta", area: "Clínica", ingreso: "2022-12-12", estatus: "Activo",
  ...
  { id: "c010", empresaId: "fisioteck", nombre: "Mariana López", puesto: "Recepción", area: "Operación", ingreso: "2024-04-22", estatus: "Incidencia",
